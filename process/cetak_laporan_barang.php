...
<body>
    ...
    <div style="page-break-after:always;text-align:center;margin-top:5%;">
        <div style="line-height:5px;">
            <h2>LAPORAN BARANG SMA IGNATIUS SLAMET RIYADI</h2>
            <h4>TGL:
        ...
        <table class="tab">
            ...
            while ($row = mysqli_fetch_array($query)): ?>
                <tr>
                   ...
                   <td><?= !empty($row['nama_barang']) ? $row['nama_barang'] : '-'; ?></td>
                    <td><?= !empty($row['nama_kategori']) ? $row['nama_kategori'] : '-'; ?></td>
                    <td><?= !empty($row['nama_merek']) ? $row['nama_merek'] : '-'; ?></td>
                    <td><?= !empty($row['nama_ruangan']) ? $row['nama_ruangan'] : '-'; ?></td>
                    <td><?= !empty($row['nama_kondisi']) ? $row['nama_kondisi'] : '-'; ?></td>
                    <td><?= !empty($row['tanggal_barang']) ? $row['tanggal_barang'] : '-'; ?></td>
                    <td><?= !empty($row['keterangan_barang']) ? $row['keterangan_barang'] : '-'; ?></td>
            ...
            endwhile; ?>
            <tr>
                <td colspan="8" align="center"><b>TOTAL BARANG</b></td>
                <td colspan="2">
                    <?= $total; ?>
                </td>
            </tr>

...
<body>
    ...
    <div style="page-break-after:always;text-align:center;margin-top:5%;">
        <div style="line-height:5px;">
            <h2>LAPORAN BARANG <?= strtoupper($jenis_transaksi); ?> SMA IGNATIUS SLAMET RIYADI</h2>
        ...
        <table class="tab">
            ...
            <?php 
                    ...
                    endwhile; ?>
            <tr>
               <td colspan="8" align="center"><b><?= strtoupper("TOTAL SEMUA BARANG " . $jenis_transaksi); ?></b></td>
                <td><?= $total; ?></td>
            </tr>
        </table>
    </div>

...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="?#">
    <div class="sidebar-brand-icon">
        <img src="assets/img/sma.png" alt="Logo" style="height: 50px;">
    </div>
</a>
    ...
    <?php if(isset($_SESSION['role'])):?>
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item <?=isset($sumber_dana)?'active':'';?>" href="?sumber_dana">Sumber Dana</a>
        </div>
    </div>
</li>
<?php endif; ?>
 ...
 <?php if($_SESSION['role'] == 'admin'):?>
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item <?=isset($barang_elektronik)?'active':'';?>" href="?barang_elektronik">Data Barang Elektronik</a>
            <a class="collapse-item <?=isset($barang_nonaktif)?'active':'';?>" href="?barang_nonaktif">Data Barang Nonaktif</a>
        </div>
    </div>
</li>
<?php endif; ?>
    ...
    <li class="nav-item <?=isset($laporan)?'active':'';?>">
        ...
        <div id="laporan" class="collapse <?=isset($laporan)?'show':'';?>" aria-labelledby="headingTwo"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item <?=isset($lap_barang_elektronik)?'active':'';?>" href="?lap_barang_elektronik">
                    Laporan Barang Elektronik</a>
                <a class="collapse-item <?=isset($lap_barang_nonaktif)?'active':'';?>" href="?lap_barang_nonaktif">
                    Laporan Barang Nonaktif</a>

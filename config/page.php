<?php
    ...
    else if(isset($_GET['sumber_dana'])){
        $master = $sumber_dana = true;
        $views = 'views/master/sumber_dana.php';
    }
    ...
    else if(isset($_GET['lap_barang_elektronik'])){
        $laporan = $lap_barang_elektronik = true;
        $views = 'views/laporan/lap_barang_elektronik.php';
    }
    else if(isset($_GET['lap_barang_nonaktif'])){
        $laporan = $lap_barang_nonaktif = true;
        $views = 'views/laporan/lap_barang_nonaktif.php';
    }

    else if(isset($_GET['barang_elektronik'])) {
        $inventaris = $barang_elektronik = true;
        $views = 'views/inventaris/barang_elektronik.php';
    }   
    else if(isset($_GET['barang_nonaktif'])) {
        $inventaris = $barang_nonaktif = true;
        $views = 'views/inventaris/barang_nonaktif.php';
    }   

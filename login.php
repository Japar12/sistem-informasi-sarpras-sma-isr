...
<head>
    ...
    <title>Sarpras SMA Ignatius Slamet Riyadi</title>
    <link rel="icon" href="assets/img/sma.png" type="image/png">
...
<div align="center">
            ...
            <div align="center" style="width:320px;margin-top:5%;">
                <form method="post" class="well well-lg p-5" action="" style="-webkit-box-shadow: 0px 0px 20px #888888;">
                    ...
                    <img src="assets/img/sma.png" alt="Logo Sekolah" style="height:90px;">

                    <h4>Selamat Datang di Sistem SARPRAS SMA ISR</h4>
                    <br>
        ...
        <footer align="center">
            Created By <a href="#" title="T.P"><i class="fa fa-copyright" aria-hidden="true">Abdul Japar Sidik</i></a>
        </footer>

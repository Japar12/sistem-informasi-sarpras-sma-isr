                ...
                <table class="table table-bordered table-hover" id="dataTable2" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= isset($row['jumlah_awal']) && $row['jumlah_awal'] !== '' ? htmlspecialchars($row['jumlah_awal']) : '-'; ?></td>
                            <td><?= isset($row['total_jumlah']) && $row['total_jumlah'] !== '' ? htmlspecialchars($row['total_jumlah']) : '-'; ?></td>
                            <td><?= !empty($row['tanggal_barang']) ? htmlspecialchars($row['tanggal_barang']) : '-'; ?></td>
